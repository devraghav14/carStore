        ...
        <Card className="mt-5">
            ...
            <CardContent>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <Textarea key={fields.description.key} name={fields.description.name} defaultValue={data.description} placeholder="Write your Product Description here!"></Textarea>
